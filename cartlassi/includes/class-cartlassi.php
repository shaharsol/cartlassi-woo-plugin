...
class Cartlassi {
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Cartlassi_Admin( $this->get_plugin_name(), $this->get_version(), $this->get_config(), $this->get_api(), $this->get_utils() );

		$this->loader->add_action( 'admin_enqueue_scripts', $plugin_admin, 'enqueue_styles' );
		$this->loader->add_action( 'admin_enqueue_scripts', $plugin_admin, 'enqueue_scripts' );
		$this->loader->add_action( 'admin_init', $plugin_admin, 'init_chart_scripts' );
		...
		$this->loader->add_action( 'admin_post_connect_shop', $plugin_admin, 'connect_shop' );
		$this->loader->add_action( 'admin_post_nopriv_connect_shop', $plugin_admin, 'connect_shop' );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Cartlassi_Public( $this->get_plugin_name(), $this->get_version(), $this->get_config(), $this->get_api(), $this->get_utils() );
